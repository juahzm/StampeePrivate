    ...
    <section class="flex-column">
        ...
        <div class="fiche-tabs">
            ...
            <input
                ...
                name="tabs"
                id="description" />
            <label for="description" class="fiche-tabs_label">Description</label>
            <div class="titres fiche-tabs_contenu rosarivo-regular">
                <h3>Description</h3>
            ...
            <input
                ...
                name="tabs"
                id="valeur" />
            <label for="valeur" class=" fiche-tabs_label">Valeur Historique</label>
            <div class=" titres fiche-tabs_contenu rosarivo-regular">
        ...
        <div class="flex-row">
            ...
            <div class="flex-row">
                ...
                <a href=""><img
                        ...
                        alt="MasterCard" /></a>
                <a href=""><img class="icon" src="{{asset}}/images/visa.png" alt="Visa" /></a>
                <a href=""><img
                        class="icon"
    ...
    <div class="cartes-defilement">
        ...
        <div class="Grille">
            ...
            <article class="Carte">
                ...
                <small>Le drapeau canadien, symbole de l'unité et de
            ...
            <article class="Carte">
                ...
                <small>Ce timbre de 1978, le pont, le patrimoine historique de
            ...
            <article class="Carte">
                ...
                <small>Un vieux navire,l'histoire maritime et l'importance du
            ...
            <article class="Carte">
                ...
                <small>L'unification des provinces en 1867 et la naissance du
            ...
            <article class="Carte">
                ...
                <small>Un timbre montrant la Statue de la Liberté, symbole de
                    liberté et d'amitié.
                    <strong>Fév 2025. 7 CAD</strong>
                </small>
                <div>
            ...
            <article class="Carte">
                ...
                <small>Un timbre symbole d'aventure et d'exploration maritime.
                    <strong>Fév 2025. 7 CAD</strong>
                </small>
                <div>
                    <a class="bouton" href="">Voir plus</a>
